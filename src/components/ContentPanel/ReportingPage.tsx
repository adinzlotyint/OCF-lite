...
import OptionButton from "./ReportingPage/OptionButton";
      ...
      <div className="flex flex-col h-full p-6 bg-white xl:ml-4 ml-0 sm:ml-8 sm:mr-8 mr-0 sm:rounded-xl rounded-none shadow-lg hover:shadow-xl transition-all">
        <div className="flex justify-between">
          ...
          <div className="h-full flex justify-start">
            <OptionButton className="min-h-8 size-8"/>
          </div>
        </div>
        ...
        <div className="flex-grow xl:min-h-[275px] sm:min-h-[100px] max-h-[500px] sm:max-h-[calc(100vh-500px)] overflow-hidden">
          <DataTable
